...
export const CarFixing = ({ providerCarTypes }) => {
  return (
    <section className='relative  flex  min-h-[calc(100vh-10.5rem)]  w-full  flex-wrap  items-center justify-center gap-4 border-b border-l border-primary bg-secondary/40 p-2 py-4'>
